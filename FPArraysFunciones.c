...
int llenado(int j, int k, int l, int m, int n, int array[2][2][2][2][2]){
    int valordimen5;
...
int mostrar(int j, int k, int l, int m, int n, int array[2][2][2][2][2]){
    printf("Arreglo: ");
